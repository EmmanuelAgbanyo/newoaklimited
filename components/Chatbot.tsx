...
export const Chatbot: React.FC = () => {
  ...
  const startLiveSession = async () => {
    // Live voice mode requires direct WebSocket connection to Gemini
    // which cannot securely proxy through serverless functions
    // Text mode remains fully functional with secure server-side API calls
    setMessages(prev => [...prev, {
      role: 'model',
      content: "Voice mode is temporarily unavailable. Please use text mode to interact with the concierge."
    }]);
